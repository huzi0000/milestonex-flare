...
## Feasibility gates — final status
...
- [x] Deploy the FTSO adapter, forwarder, and escrow from the entrant's dedicated test wallet
- [x] Approve test FXRP and fund test projects
- [x] Release milestones on Coston2
- [x] Record contract addresses and transaction hashes

Completion evidence is published in `DEPLOYMENT_VERIFICATION.md`, `PROJECT_1_VERIFICATION.md`, `PROJECT_2_VERIFICATION.md`, and the machine-readable files under `contracts/deployments/`.
